<template>
  <div class="side_con">
    ...
    <el-scrollbar class="list">
      <el-menu
        :class="[menuDeative ? 'menu_deactive' : '']"
      ...
      >
        ...
        <el-sub-menu index="1">
          ...
          <el-menu-item
            :index="`1-${++index}`"
            v-for="(item, index) in knowledgeStore.knowledgeList"
            :key="index"
