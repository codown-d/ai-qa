<template>
  <el-dialog v-model="dialogVisible" width="35.41%" modal-class="custom-modal" :show-close="false">
    <template #title>
    ...
    <template #footer>
      <div class="u-flex flex-r-c" style="justify-content: flex-end;">
        <div class="btn cancel" @click="dialogVisible=false">取消</div>
        <div class="btn ml20" @click="save">提交</div>
      </div>
    </template>
  </el-dialog>
</template>
